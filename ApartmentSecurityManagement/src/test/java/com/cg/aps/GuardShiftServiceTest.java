...
class GuardShiftServiceTest {
	@MockBean     //add mocks to a Spring ApplicationContext
	GuardShiftDao dao;
	...
	@Test  
	 ...
	 void testAddGuardShiftTraining() throws DuplicateRecordException
	{
	...
	@Test
	 void testAddGuardShiftWrong() throws DuplicateRecordException {
		String guardno = "7476";
		GuardShiftEntity obj = new GuardShiftEntity(1, "yash", "aditya", Date.valueOf(LocalDate.now()));
	...
	@Test
	//Testing with existing record
	 void testAddExistingGuardShift() throws DuplicateRecordException {
		String guardno = "103";
		GuardShiftEntity obj = new GuardShiftEntity(1, "yash", "aditya", Date.valueOf(LocalDate.now()));
	...
	@Test 
	 void testUpdateGuardShiftTraining() throws RecordNotFoundException
	{
	...
	@Test 
	//testing duplicate update
	 void testUpdateGuardShiftTrainingWrong() throws RecordNotFoundException
	{
	...
	@Test 
	//testing delete
	 void testDeleteGuardShiftTraining() throws RecordNotFoundException
	{
		//GuardShiftEntity obj = new GuardShiftEntity(1, "yash", "aditya", Date.valueOf(LocalDate.now()));
...
@Test 
	//testing duplicate delete
	 void testDeleteGuardShiftWrongTraining() throws RecordNotFoundException
	{
		//GuardShiftEntity obj = new GuardShiftEntity(1, "yash", "aditya", Date.valueOf(LocalDate.now()));
		Optional<GuardShiftEntity> obj1 = Optional.of(new GuardShiftEntity(1,null, null, null, null, 7, "yash", "aditya", Date.valueOf(LocalDate.now())));
		//service.delete(obj.getUserId());
 ...
 catch(RecordNotFoundException e)
 {
	 ...
	 void testSearch() throws DatabaseException
	{
		...
		List<GuardShiftEntity> list1  = new ArrayList<GuardShiftEntity>();
		list1.add(obj);
		list1.add(obj1);
	...
	@Test
	//testing for duplicate searching
