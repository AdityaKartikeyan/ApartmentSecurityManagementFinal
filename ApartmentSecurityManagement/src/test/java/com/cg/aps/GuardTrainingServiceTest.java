...
//putting incorrect details
	...
	//find id putting incorrect details
	@Test
	 ...
	 void testSearch() throws DatabaseException
	{
		...
		List<GuardTrainingEntity> list1  = new ArrayList<GuardTrainingEntity>();
		list1.add(obj);
		list1.add(obj1);
	...
	//testing search without details
	...
	//testing search all incorrect details
	@Test
