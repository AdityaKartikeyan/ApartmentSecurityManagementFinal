...
class GuardSalaryServiceTest {
	...
	@Test
	void testAddGuardSalary() throws DuplicateRecordException {

		GuardSalaryEntity obj = new GuardSalaryEntity("aravind", 2000, "101", "credited",
	...
	@Test
	void testAddGuardSalaryWrong() throws DuplicateRecordException {
		long userId1 = 123;
		GuardSalaryEntity obj = new GuardSalaryEntity("aravind", 2000, "101", "credited",
				Date.valueOf(LocalDate.now()));
	...
	@Test
	void testAddGuardSalaryExistingRec() throws DuplicateRecordException {
		long userId1 = 2000;
		GuardSalaryEntity obj = new GuardSalaryEntity("aravind", 2000, "101", "credited",
				Date.valueOf(LocalDate.now()));
	...
	@Test
	void testUpdateGuardSalary() throws RecordNotFoundException {
	...
	@Test
	void testUpdateGuardSalaryWrong() throws RecordNotFoundException {
	...
	@Test
	void testDeleteGuardSalary() throws RecordNotFoundException {
		/*
		 * GuardSalaryEntity obj = new GuardSalaryEntity("aravind", 2000, "101",
		 * "credited", Date.valueOf(LocalDate.now()));
		 */
		Optional<GuardSalaryEntity> obj1 = Optional.of(new GuardSalaryEntity(1, "aravind", null, null, null, null, 2000,
				"101", "credited", Date.valueOf(LocalDate.now())));
	...
	@Test
	void testDeleteGuardSalaryWrong() throws RecordNotFoundException {
		/*
		 * GuardSalaryEntity obj = new GuardSalaryEntity("aravind", 2000, "101",
		 * "credited", Date.valueOf(LocalDate.now()));
		 */
	...
	void testFindByName() throws RecordNotFoundException {
		...
		Optional<GuardSalaryEntity> obj = Optional
				.of(new GuardSalaryEntity("aravind", 2000, "101", "credited", Date.valueOf(LocalDate.now())));
	...
	void testSearch() throws DatabaseException {
		GuardSalaryEntity obj = new GuardSalaryEntity("aravind", 2000, "101", "credited",
				Date.valueOf(LocalDate.now()));
		GuardSalaryEntity obj1 = new GuardSalaryEntity("anshul", 2000, "102", "received",
				Date.valueOf(LocalDate.now()));

		List<GuardSalaryEntity> list1 = new ArrayList<GuardSalaryEntity>();
		list1.add(obj);
		list1.add(obj1);
