...
public class GuardSalaryController {
	...
	public ResponseEntity<GuardSalaryEntity> addGuardSalary(@RequestBody GuardSalaryEntity guard)
	...
	@ApiOperation(value = "Update GuardSalary", response = GuardSalaryEntity.class, tags = "update-GuardSalary", httpMethod = "PUT")
	@PutMapping("/updateGuardSalary/{id}")
	public ResponseEntity<GuardSalaryEntity> updateGuardSalaryEntity(@PathVariable("id") long id, @RequestBody GuardSalaryEntity GuardSalary)
			throws RecordNotFoundException {
		GuardSalary.setName(GuardSalary.getName());
		GuardSalary.setAmount(GuardSalary.getAmount());
		GuardSalary.setStatus(GuardSalary.getStatus());
		
		
		GuardSalaryEntity updateGuardSalary = service.update(GuardSalary);
		return new ResponseEntity<GuardSalaryEntity>(updateGuardSalary, HttpStatus.OK);
	...
	public ResponseEntity<String> deleteGuardSalary(@PathVariable("id") long id) throws RecordNotFoundException {
