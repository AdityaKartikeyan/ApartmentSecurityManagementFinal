...
public class SecurityController {
	...
	@ApiOperation(value="Add Security",
			...
			tags = "add-security",
			httpMethod = "POST")
	@PostMapping("/addSecurity")   //Adding a Security
	...
	@PutMapping("/updateGuard")  //Updating a Security
	...
	@ApiOperation(value="Delete Security",
			...
			httpMethod = "DELETE")
	@DeleteMapping("/deleteSecurity/{id}")  //Deleting a Security
	...
	@ApiOperation(value="Get Security Details by alertId",
			...
			httpMethod = "GET")
	@GetMapping("/getById/{id}")        //Getting Security by alertid
	...
	@ApiOperation(value="Get All Security Details",
			...
			httpMethod = "GET")
	@GetMapping("/getAll")            //Getting All Security details 
