...
public class DomesticHelpController {
	...
	@PutMapping("/updateDomesticHelp/{id}")

	public ResponseEntity<DomesticHelpEntity> updateDomesticHelpTraining(@PathVariable("id") String id, @RequestBody DomesticHelpEntity DomesticHelp) throws RecordNotFoundException {
		DomesticHelp.setFlatNo(DomesticHelp.getFlatNo());
		DomesticHelp.setOwnerName(DomesticHelp.getOwnerName());
		DomesticHelp.setName(DomesticHelp.getName());
		DomesticHelp.setHelpType(DomesticHelp.getHelpType());
		DomesticHelp.setArrivalTime(DomesticHelp.getArrivalTime());
		DomesticHelp.setDepartureTime(DomesticHelp.getDepartureTime());
