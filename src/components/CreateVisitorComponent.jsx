...
class CreateVisitorComponent extends Component {
  ...
  saveVisitor = (e) => {
    ...
    if (formValid(this.state)) {
      ...
      VisitorService.createVisitor(visitors).then((res) => {
  ...
  formValChange = (e) => {
    ...
    switch (name) {
      case "visitorId":
        isError.visitorId = regExp2.test(value)
          ? ""
          : "Numeric Value Required for Visitor ID";
        break;
      case "name":
        isError.name =
          value.length < 3
            ? "Atleast 3 characters required for Visitor's name"
            : "";
        break;
      case "ownerName":
        isError.ownerName =
          value.length < 3
            ? "Atleast 3 characters required for Owner's name"
            : "";
        break;
      case "flatNo":
        ...
        <div className="container">
          <div className="row">
            <div className="card col-md-6 offset-md-3 offset-md-3">
              <h3 className="text-center">Add Visitor Details</h3>
                ...
                <form>
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={
                        (this.changeVisitorIdHandler, this.formValChange)
                      }
                    />
                    {isError.visitorId.length > 0 && (
                      <span className="invalid-feedback">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={
                        (this.changeVisitorNameHandler, this.formValChange)
                      }
                    />
                    {isError.visitorId.length > 0 && (
