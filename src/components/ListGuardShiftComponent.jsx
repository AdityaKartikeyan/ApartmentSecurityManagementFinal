...
class ListGuardShiftComponent extends Component {
  ...
  baseEntity(userId) {
    this.props.history.push(`/getByPk8/${userId}`);
  }
  ...
  viewGuardShift(userId) {
    this.props.history.push(`/getByGuardShiftId/${userId}`);
  }
  deleteGuardShift(id) {
            ...
            <tbody>
              {this.state.guardShift.map((guardShift) => (
                <tr key={guardShift.userId}>
                  ...
                  <td>
                    <button
                      onClick={() => this.editGuardShift(guardShift.userId)}
                    ...
                    <button
                      style={{ marginLeft: "10px" }}
                      onClick={() => this.viewGuardShift(guardShift.userId)}
