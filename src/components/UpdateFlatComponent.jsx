...
class UpdateFlatComponent extends Component {
  ...
  updateFlat = (e) => {
    ...
    if (formValid(this.state)) {
      ...
      FlatService.updateFlat(flat, this.state.flatNo).then((res) => {
  ...
  formValChange = (e) => {
    ...
    switch (name) {
      ...
      case "ownerName":
        isError.ownerName =
          value.length < 5 ? "Atleast 5 character required " : "";
        break;
      case "flatNo":
              ...
              <form>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(this.changefloorNoHandler, this.formValChange)}
                  />
                  {isError.floorNo.length > 0 && (
